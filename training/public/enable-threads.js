...
if(typeof window === 'undefined') { // This code only runs if it's inside the Service Worker
...
} else { // This code initializes the service worker.
  (async function() {
    if(window.crossOriginIsolated) return; // Don't init service worker if we're already cross-origin isolated.
